<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 py-3 navbar-border">
    <!-- Primary Navigation Menu -->
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-12">
            <div class="flex justify-start align-start">
                <!-- Logo -->
                <div class="shrink-0 flex items-center" style="margin-left: -16px !important;">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <!--accueil-->
                    <x-jet-nav-link href="{{ route('home.about') }}" :active="request()->routeIs('home.about')">
                        {{ __('Accueil') }}
                    </x-jet-nav-link>
                    ...
                    @auth()
                        ...
                        <x-jet-nav-link href="{{ route('conversations.index') }}" :active="request()->routeIs('conversations.index')">
                            {{ __('Messagerie') }}
                        </x-jet-nav-link>
                ...
                @auth
                    <div class="ml-3 relative">
                        <x-jet-dropdown align="right" width="48">
                            ...
                            <x-slot name="content">
                                <!-- Account Management -->
                                <div class="block px-4 py-2 text-xl text-blue-600">
                                    {{ Auth::user()->firstname }} {{ Auth::user()->lastname }}
                                </div>
            ...
            <!-- Hamburger -->
            <div class="-mr-1flex items-center sm:hidden">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{ route('home.about') }}" :active="request()->routeIs('home.about')">
                {{ __('Accueil') }}
            ...
            @auth()
                <x-jet-responsive-nav-link href="{{ route('panel.index') }}"
                                           :active="request()->routeIs('panel.index')">
                    {{ __('Panel') }}
                </x-jet-responsive-nav-link>

                <x-jet-responsive-nav-link href="{{ route('conversations.index') }}"
                                           :active="request()->routeIs('conversations.index')">
                    {{ __('Messagerie') }}
                </x-jet-responsive-nav-link>

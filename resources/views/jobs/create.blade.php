        ...
        <div class="row">
            ...
            <!--titre de l'annonce-->
                <div class="form-group mt-3">
                    ...
                    <input type="text" name="title" class="form-control rounded" value="{{ old('title') }}"
                           placeholder="Mon super titre" required>
                </div>
                <!--titre de l'annonce/-->
                ...
                <div class="form-group mt-3">
                    ...
                    <input type="number" name="time" value="{{ old('time') }}" class="form-control rounded" placeholder="30"
                           min="1" required>
                </div>
                <!--durée du stage/-->
                ...
                <div class="form-group mt-3">
                    ...
                    <textarea class="form-control rounded text-left p-3 font-thin w-100" name="description"
                              value="{{ old('description') }}"
                              placeholder="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque tincidunt imperdiet magna, at venenatis lorem euismod ac. Donec blandit sem vitae consequat tincidunt. In orci mauris, tincidunt ornare facilisis rhoncus, maximus eu dolor.
                                            Nunc nec risus aliquam lectus volutpat laoreet in nec ligula. Curabitur tincidunt velit varius convallis posuere."
                              required></textarea>
                </div>
                <!--contenu de l'annonce/-->
            ...
            <!--profession-->
                <div class="form-group mt-3">
                    ...
                    <select class="form-control" name="profession_id" id="profession_id">
                        <option value="{{ old('profession_id') }}" selected>Choisissez une profession</option>
            ...
            <!--province/-->
                ...
                <div class="form-group mt-3">
                    ...
                    <select class="form-control" name="city_id" id="city_id" id="exampleFormControlSelect1" required>
                        <option value="{{ old('city_id') }}" selected>Choisissez une ville.</option>
